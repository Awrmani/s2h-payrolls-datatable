...
<div {{ $attributes->merge(["class" => " sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-2"]) }}>
    <label class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2 uppercase {{ isset($column['input_class']['label']) ? $column['input_class']['label'] : '' }}">
